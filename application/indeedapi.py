...
class IndeedClient:
    ...
    def search(self, **args):
        return self.__process_request(API_SEARCH.get('end_point'),
                                      self.__valid_args(API_SEARCH.get('required_fields'), args))

    def jobs(self, **args):
        return self.__process_request(API_JOBS.get('end_point'),
                                      self.__valid_args(API_JOBS.get('required_fields'), args))
